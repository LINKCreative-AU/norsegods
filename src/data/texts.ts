...
export const texts: Entity[] = [
  ...
  },
  {
    ...
    description: [
      "Völuspá is the mythology's spine in sixty-odd stanzas. A völva, a seeress speaking from beyond death, commands the hearing of 'all holy kindreds' and addresses Odin directly, unrolling everything: the yawning void, the building of the world, the first golden age and the three maidens who ended it, the first war, the death of Baldr, the bound wolf. Then, refrain by tolling refrain ('the fetter will break and the wolf run free'), she runs the full sequence of Ragnarök, through fire and falling stars to the earth rising green from the sea a second time.",
