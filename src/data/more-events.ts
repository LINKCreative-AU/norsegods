...
export const moreEvents: Entity[] = [
  ...
  },
  {
    ...
    summary:
      "Three gods walking the new shore found two trees, 'capable of little, fateless', and gave them breath, a working mind and warmth. Every human is driftwood the gods stopped to finish.",
    description: [
  ...
  },
  {
    ...
    summary:
      "After Baldr's death and the feast of insults, the gods hunt Loki to a mountain hideout, net him from a salmon's shape, and bind him under dripping venom with his own son's entrails, where he lies until Ragnarök.",
    description: [
      "Loki knew he had finally spent the gods' patience. After Baldr's death, after Þökk's dry eyes, after the feast where he read the pantheon its charges, he ran: a house on a mountain with doors on all four sides, and days spent as a salmon in the falls of Fránangr. Idle by the fire, he invented the fishing net, then burned it when he saw the gods coming. But Kvasir (in this account the wisest of the Æsir) read the net's shape in the ashes. His own cleverness, reverse-engineered, caught him: netted on the third pass, gripped by Thor at the tail, which is why salmon taper.",
